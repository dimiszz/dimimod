...
import net.dimi.dimimod.world.feature.ModConfiguredFeatures;
import net.dimi.dimimod.world.feature.ModPlacedFeatures;
...
@Mod(DimiMod.MOD_ID)
public class DimiMod {
    public static final String MOD_ID = "dimimod";
