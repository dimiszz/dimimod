package net.dimi.dimimod.world.feature;
...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, DimiMod.MOD_ID);
    public static final Supplier<List<OreConfiguration.TargetBlockState>> STONE_ZIRCON_ORES = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, ModBlocks.ZIRCON_ORE.get().defaultBlockState())));
    public static final Supplier<List<OreConfiguration.TargetBlockState>> DEEPSLATE_ZIRCON_ORES = Suppliers.memoize(() -> List.of(
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> DEEPSLATE_ZIRCON_ORE = CONFIGURED_FEATURES.register("deepslate_zircon_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(DEEPSLATE_ZIRCON_ORES.get(),7)));
    public static final RegistryObject<ConfiguredFeature<?, ?>> STONE_ZIRCON_ORE = CONFIGURED_FEATURES.register("stone_zircon_ore",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(STONE_ZIRCON_ORES.get(),7)));
